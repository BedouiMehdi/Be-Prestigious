...
<body>
  ...
  <div class="owl-carousel owl-single px-0">
    <div class="site-blocks-cover overlay" style="background-image: url('images/hero_bg_3.jpg') ; height="200"">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 mx-auto align-self-center">
            <div class="site-block-cover-content text-center">
              <h1 class="mb-0"><strong class="text-primary">BE Prestigious</strong> Opens 24 Hours</h1>
              ...
              <p><a href="addcommande.php" class="btn btn-primary px-5 py-3">Shop Now</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url('images/hero_bg_02.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 mx-auto align-self-center">
            <div class="site-block-cover-content text-center">
              <h1 class="mb-0">New Products <strong class="text-primary">Everyday</strong></h1>
              <div class="row justify-content-center mb-5">
                <div class="col-lg-6 text-center">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis ex perspiciatis non quibusdam vel quidem.</p>
                </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="feature">
            ...
            <h3><a href="#">New Products Everyday</a></h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa laborum voluptates excepturi neque labore .</p>
            <p><a href="#" class="d-flex align-items-center"><span class="mr-2">Learn more</span> <span class="icon-keyboard_arrow_right"></span></a></p>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="feature">
            ...
            <h3><a href="#">Products Guaranteed</a></h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa laborum voluptates excepturi neque labore .</p>
            <p><a href="#" class="d-flex align-items-center"><span class="mr-2">Learn more</span> <span class="icon-keyboard_arrow_right"></span></a></p>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="title-section text-center col-12">
          <h2>BE Prestigious <strong class="text-primary">Products</strong></h2>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12 block-3 products-wrap">
          <div class="nonloop-block-3 owl-carousel">
            ...
            <div class="text-center item mb-4 item-v2">
              ...
              <a href="addcommande.php"> <img src="images/product_011.jpg" height="500"alt="Image"></a>
              <h3 class="text-dark"><a href="addcommande.php">Umcka Cold Care</a></h3>
              <p class="price">$120.00</p>
            </div>

            <div class="text-center item mb-4 item-v2">
              <a href="addcommande.php"> <img src="images/product_0111.jpg" height="500"  width="100" alt="Image"></a>
              <h3 class="text-dark"><a href="addcommande.php">Umcka Cold Care</a></h3>
              <p class="price">$120.00</p>
            </div>
            ...
            <div class="text-center item mb-4 item-v2">
              <span class="onsale">Sale</span>
              <a href="addcommande.php"> <img src="images/product_022.jpg"height="500" alt="Image"></a>
              <h3 class="text-dark"><a href="addcommande.php">Umcka Cold Care</a></h3>
              <p class="price">$120.00</p>
            </div>

            <div class="text-center item mb-4 item-v2">
              <a href="addcommande.php"> <img src="images/product_044.jpg" height="500" alt="Image"></a>
              <h3 class="text-dark"><a href="addcommande.php">Umcka Cold Care</a></h3>
              <p class="price">$120.00</p>
            </div>
  ...
  <div class="site-section bg-image overlay" style="background-image: url('images/hero_bg_02.jpg');">
    <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          ...
          <div class="block-7">
            <h3 class="footer-heading mb-4">About <strong class="text-primary">Virupedia</strong></h3>
