                                ...
                                <tr class="table-primary">
                                    ...
                                    <td>
                                        <form method="POST" action="../../controller/supprimerarticle.php">
											 ...
											 <input type="image" src="bouton/supprimer.png" name="supprimer" value="supprimer" width="60"
                                    height="60">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" href="modifierarticles.php?idNewsArticle=<?PHP echo $row['idNewsArticle']; ?>">    <input name="modifier" type="image" src="modifier.png" width="30"
                                    height="30"> </a>
