                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <?PHP
                                ...
                                $listeEmployes=$commande1c->affichercommandenom();
								
if(isset($_POST['nom']))
{
  if(($_POST['nom'] == ""))
  {
   $listeEmployes=$commande1c->affichercommandeadresse();
  }
  else
  {
    ...
    foreach($listeEmployes as $row){
        ...
        <tr>
            ...
            <td><form method="POST" action="supprimercommande.php">
			 <FONT face=”Arial”>  
                     <input type="image" src="supprimer.png" name="supprimer" value="supprimer" width="30"
                                    height="30">
