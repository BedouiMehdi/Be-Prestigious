                            ...
                            <tr>
                                <td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" rowspan="3" bgcolor="#FFFFFF" style="padding:0 0 30px;">
                                                    <!-- begin content -->
                                                    <img src="https://lh3.googleusercontent.com/RRTwtBrhLkt0flAq05pfYmsOdw7bOWRRidJSTuxvPzNQjzKEWgMnfPJMykkklYfUIAV5rA=s96" width="100" height="100" alt="summer‘s coming trimm your sheeps" style="display:block; border:0; margin:0 0 44px; background:#eeeeee;">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            <tr valign="top">
                                                                ...
                                                                <td>
                                                                    <center> <a style="display:block; margin:0 0 14px;" href="https://localhost/allfolders/views/front/blogs-details.php?idNewsArticle={{ idNewsArticle0 }}"><img src="https://2aszhi3llh0x466uws21w6cc-wpengine.netdna-ssl.com/wp-content/uploads/writing-new-blog-post-1024x682.jpg" style="width:50%;"></a></center>
                                                                    <p style=" font-size:14px; line-height:22px; font-weight:bold; color:#333333; margin:0 0 5px;"><a href="https://localhost/allfolders/views/front/blogs-details.php?idNewsArticle={{ idNewsArticle0 }}" style="color:#6c7e44; text-decoration:none;">{{ titre0 }}</a></p>
                                                                </td>
                                                    ...
                                                    <h2 style="color: #000000;  font-family: sans-serif; font-weight: 400; line-height: 1.4;  margin: 0;  margin-bottom: 30px; text-align: center; font-size: 25px; font-weight: 300;">
                                                        We are pleased to announce our new Article , we worked hard to make sure it contains valuable information
                                                        We invite you to view the new Article and let us know your thoughts.
                                                        For any questions, feedback or comments, please E-mail us.
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            <tr valign="top">
                                                                ...
                                                                <td>
                                                                    <p style="margin:0 0 4px; font-weight:bold; color:#333333; font-size:14px; line-height:22px;">Virupedia.</p>
                                                                    <p style="margin:0; color:#333333; font-size:11px; line-height:18px;">
                                                                        <!--
                                                                    400005 Russian Federation, Volgograd, prospekt Lenina 56--><br>
                                                                        Contact: Virupedia@outlook.fr<br>
                                                                        Website: <a href="https://localhost/allfolders/views/front/index.php" style="color:#6d7e44; text-decoration:none; font-weight:bold;">www.Virupedia.com</a>
                                                                    </p>
                                                                </td>
                                                                <td width="30">
                                                                    <p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p>
                                                                ...
                                                                <td width="120">
                                                                    ...
                                                                    <a href="https://localhost/allfolders/views/front/index.php" style="color:#6d7e44; text-decoration:none;">Visit website</a><br>
                                                                    </p>
                                                                </td>
                                                                <td width="30">
                                                                    <p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p>
                                    ...
                                    <p style="margin:0; padding:34px 0 0; text-align:center; font-size:11px; line-height:13px; color:#333333;">
                                        Don‘t want to recieve further emails? You can unsibscribe <a href="http://291b35bc.ngrok.io/projetWeb/core/supprimerNewsLettersVisiteurs.php?idVisiteur={{ idVisiteurx }}" style="color:#333333; text-decoration:underline;">here</a>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
