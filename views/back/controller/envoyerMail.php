...
require_once 'C:/wamp64/www/allfolders/controller/ajouterArticle.php';
//require_once 'C:/wamp64/www/allfolders/model/Articles.php';
$articleC = new articleC();
$listearticle = $articleC->lastArticle();


require_once 'C:/wamp64/www/lib/phpmailer/PHPMailerAutoLoad.php';
...
foreach ($listemails as $row) {
	...
	foreach ($listearticle as $article) {
		...
		/*$body =
			...
			. "<a href='https://localhost/allfolders/views/front/blogs-details.php?idNewsArticle=7' class='btn btn-primary'>Go somewhere</a>"
			. "</div>"
			. "</div>"
			. "</body>"
